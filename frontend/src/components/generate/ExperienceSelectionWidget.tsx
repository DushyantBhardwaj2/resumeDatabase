...
export function ExperienceSelectionWidget({ content }: { content?: string }) {
  ...
  if (!profile || !profile.experience?.length) {
    return (
      <div className="mt-4 flex justify-end">
        <button 
          onClick={() => addChatEntry({ role: 'assistant', type: 'project-selection', content: "Next up, let's review your Projects." })}
  ...
  const handleNext = () => {
    addChatEntry({ role: 'assistant', type: 'project-selection', content: "Next up, let's review your Projects." })
  }
